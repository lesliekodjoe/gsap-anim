...
const Footer = () => {
  return (
    <footer className="py-20 text-black bg-gradient-to-r from-[#C9729A] to-[#923ADB] fixed bottom-0 w-full">
      <div className="px-44 flex items-center justify-between">
        <div className="flex items-center ">
          ...
          <p className="text-3xl ml-2 font-bold">All of this, coming in 2022.</p>
        </div>
        <div className="flex items-center">
          <p className="mr-5 font-semibold ">Learn more by following us: </p>
          <a
            href="https://twitter.com/skillformio"
            target="_blank"
          ...
          >
            ...
            <p className="font-semibold">skillform</p>
          </a>
        </div>
      </div>
    </footer>
